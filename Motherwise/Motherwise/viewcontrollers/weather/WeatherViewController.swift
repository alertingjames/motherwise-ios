...
//            let background:DarkBackground = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "DarkBackground") as! DarkBackground
...
//            self.view.addSubview(background.view)
    ...
    func showLoadingView(){
        ...
        loadingView.color = UIColor.green
    ...
    func showInputDialog(title:String, button_text:String, index:Int){
        let inputDialog:InputDialog = self.storyboard!.instantiateViewController(withIdentifier: "InputDialog") as! InputDialog
        ...
        self.addChild(inputDialog)
        self.view.addSubview(inputDialog.view)
    }
